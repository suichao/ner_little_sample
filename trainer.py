...
from datamodule import FSNERDataModule
...
def init_trainer_parser(parser):
    ...
    parser.add_argument('--pretrained-model', help='Pretrained model name or path',
                        default="./pretrain/chinese/")
    parser.add_argument('--mode', help='Run for training or evaluation', choices=['train', 'eval'], default='train')
    ...
    parser.add_argument('--train-data', help='Train data as json file', default="./data/train.json")
    parser.add_argument('--val-data', help='Validation data as json file', default="./data/val.json")
    parser.add_argument('--train-batch-size', help='Training batch size', default=1, type=int)
    parser.add_argument('--val-batch-size', help='Validation batch size', default=1, type=int)
    parser.add_argument('--n-examples-per-entity', help='Number of examples per entity', default=3, type=int)
...
def trainer_main(args):
    ...
    print("args.n_examples_per_entity", args.n_examples_per_entity)
...
if __name__ == '__main__':
    ...
    # parser.add_argument("pretrain/chinese/")
